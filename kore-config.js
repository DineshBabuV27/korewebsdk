(function(KoreSDK){
    ...
    botOptions.JWTUrl = "https://back-end-1-zvp2.onrender.com/get-token"; //hosted url(endpoint)
    botOptions.userIdentity = 'meena.chitrala@genpact.com';// Provide users email id here
